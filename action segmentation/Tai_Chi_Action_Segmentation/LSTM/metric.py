...
def f1(gt, recog, thera):
    ...
    sequence = [0,639,1299,2010,2672,3413,4141,4805,5403,6090,6866,7528,8269,8903,9771]
    for aa in range(0,14):
        gt_content = gt[sequence[aa]:sequence[aa+1]]
        recog_content = recog[sequence[aa]:sequence[aa+1]]
